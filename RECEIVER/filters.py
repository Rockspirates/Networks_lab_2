...
def high_pass_filter(input_file = 'output.wav', output_file = 'output.wav', cutoff_freq=425):
    # Load the .wav file
    ...
    # Apply the high-pass filter by zeroing out frequencies below the cutoff
...
def low_pass_filter(input_file = 'output.wav', output_file = 'output.wav', cutoff_freq=650):
    # Load the .wav file
    with wave.open(input_file, 'rb') as wf:
        sample_rate = wf.getframerate()
        n_frames = wf.getnframes()
